#include "expr.h"
map<Hash, Expr*> Expr::Expr_hashmap;
...
//            print();
            ...
            for (auto &x : Sum) {
//                x.second.printtrig();  cout << endl;
//                x.second.getHash().print();  cout << endl;
...
Expr operator ^ (Expr A,Expr B) {
    if (B.TYPE == Expr::NUM && B.Num.isRational()) {
        if (A.TYPE == Expr::MUL) {
        ...
        else if (A.TYPE == Expr::NUM && A.Num.isRational()) {
            Expr C;
            C.TYPE = Expr::NUM;
            ...
            if (tmp->Num.isRational()) {
//                tmp->Num.printtrig();  cout << endl;
//                B.Num.printtrig();  cout << endl;
...
void Expr::print() const {
    bool fi = true;
    cout << "Hash = ";  hash.print();  cout << endl << "TYPE = ";
    switch (TYPE) {
        case e:
            cout << "E" << endl;
            Num.printtrig();  cout << " * E";
            break;

        case pi:
            cout << "PI" << endl;
            Num.printtrig();  cout << " * PI";
            break;

        case NUM:
            cout << "NUM" << endl;
            Num.printtrig();  cout << " * I";
            break;
        ...
        case SUM:
            ...
            for (const auto &p : Sum) {
                ...
                cout << "({";  p.second.printtrig(); cout << "} * ";  cout << "Expr->";  p.first.print();  cout << ")";
            }
            break;

        case MUL:
            cout << "MUL" << endl;
            cout << "(Num = ";  Num.printtrig();  cout << ") * ";
            for (const auto &p : Mul) {
                if (fi) fi = false;
                else cout << " * ";
                cout << "({";  cout << "Expr->";  p.first.print();  cout << "} ^ ";   p.second.print();  cout << ")";
            }
            break;
        ...
        case ABS:
            cout << "ABS" << endl;
            cout << "(Num = ";  Num.printtrig();  cout << ") * abs { ";
            cout << "Expr->";  F->getHash().print();
            cout << " }";
            break;
        ...
        case SIN:
            cout << "SIN" << endl;
            cout << "(Num = ";  Num.printtrig();  cout << ") * sin { ";
            cout << "Expr->";  F->getHash().print();
            cout << " }";
            break;
        ...
        case COS:
            cout << "COS" << endl;
            cout << "(Num = ";  Num.printtrig();  cout << ") * cos { ";
            cout << "Expr->";  F->getHash().print();
            cout << " }";
            break;
        ...
        case TAN:
            cout << "TAN" << endl;
            cout << "(Num = ";  Num.printtrig();  cout << ") * tan { ";
            cout << "Expr->";  F->getHash().print();
            cout << " }";
            break;
        ...
        case LN:
            cout << "LN" << endl;
            cout << "(Num = ";  Num.printtrig();  cout << ") * LN { ";
            cout << "Expr->";  F->getHash().print();
            cout << " }";
            break;
    }
